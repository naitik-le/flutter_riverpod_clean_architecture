                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: AppTextStyles.display(textThemeColor),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      'The premium, offline-first collaborative suite.',
                      textAlign: TextAlign.center,
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                hintText: 'e.g. dev@collaborative.com',
                    ...
                    const SizedBox(height: 24),
                    Text(
                      'Press Access Workspace to login with mock credentials',
                      textAlign: TextAlign.center,
                      style: AppTextStyles.caption(secondaryTextColor),
                    ),
                  ],
